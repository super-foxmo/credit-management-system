<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['structure:college:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['structure:college:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['structure:college:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['structure:college:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="collegeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="学院_id" align="center" prop="collegeId" />
...
<script>
import { listCollege, getCollege, delCollege, addCollege, updateCollege } from "@/api/structure/college";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除学院信息编号为"' + collegeIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('structure/college/export', {
        ...this.queryParams

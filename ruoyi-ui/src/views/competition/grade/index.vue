<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['competition:grade:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['competition:grade:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['competition:grade:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['competition:grade:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="gradeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="等级编号" align="center" prop="gradeId" />
...
<script>
import { listGrade, getGrade, delGrade, addGrade, updateGrade } from "@/api/competition/grade";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除竞赛等级编号为"' + gradeIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('competition/grade/export', {
        ...this.queryParams
